...
```javascript
{
  ...
  finalUrl: "https://example.com/article-full",
...
Many paper repositories show a landing/redirect page before the actual PDF or article:

```
Initial load: "Redirecting to article..." (500 chars)
  ↓ (redirect detected in 2s)
Final page: Full article text (15000 chars) ✓
```
...
Final: Paywall or article content ✓
```
...
<script>
  setTimeout(() => {
    document.getElementById('content').textContent = 
      'Very long article content...'.repeat(100);
  }, 2000);
</script>
</html>
```
